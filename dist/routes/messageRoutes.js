...
router.get('/user/:userId', messageController_1.getConversation);
// Récupérer une conversation avec un parking spécifique
router.get('/parking/:parkingId', messageController_1.getParkingConversation);
...
router.patch('/read', messageController_1.markMessagesAsRead);
